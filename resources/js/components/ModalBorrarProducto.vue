<template>
    <!-- Modal -->
    <div class="modal fade bd-example-modal-xl" id="modalBorrarProducto" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">
                        Esta seguro de borrar el producto {{producto?producto.nombre:'indefinido'}}
                    </h5>
...
<script>
    export default {
        ...
        methods: {
            confirmarBorrar(){
                this.cargando = true;
                axios.delete('/producto/'+this.producto.id)
                    .then((response) => {
